...
(
    ...
    INDEX `idx_user_id` (`user_id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户授权关联表';

INSERT IGNORE INTO `sys_role` (`id`, `role_name`, `role_key`) VALUES (1, '管理员', 'admin');
INSERT IGNORE INTO `sys_role` (`id`, `role_name`, `role_key`) VALUES (2, '普通用户', 'user');